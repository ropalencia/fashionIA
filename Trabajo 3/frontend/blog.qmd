...
aqui poner la introdución del trabajo 2


# Análisis de requisitos del sistema

aqui poner una tabla con los requisitos o historias de usuarios basicas 

# Diagrama de arquitectura

aqui porner una imagen con el digrama de bases de datos 

# Evidencias de pruebas funcionales

Para el desarrollo de este trabajo se uso una base datos 
...
Ejemplo de la base de datos inicial con la que se trabajara el problema 
